...
inputs = Input(shape=input_shape, name = 'encoder_input')
x = Conv2D(16, (3,3), padding = 'same', strides = (1,1), activation = 'relu')(inputs)
...
x = UpSampling2D((2,2))(x)
outputs = Conv2D(input_shape[2], (3,3), padding = 'same', strides = (1,1), activation = 'linear')(x)
...
if __name__ == '__main__':
    ...
    vae.compile(loss=my_vae_loss ,optimizer='adam')
    vae.summary()
    plot_model(vae,
               to_file='vae_mlp.png',
               show_shapes=True)
