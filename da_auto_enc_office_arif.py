...
print("s_input_shape",s_input_shape)
print("t_input_shape",t_input_shape)
...
class S_T_AE():
    ...
    def build_s_enc_cls_model(self):
        ...
        self.s_enc_cls_model = Model(self.s_encoder.input, self.classifier(self.s_encoder.output))
    ...
    def build_t_enc_cls_model(self):
        ...
        self.t_enc_cls_model = Model(self.t_encoder.input, self.classifier(self.t_encoder.output))
...
x_s_train = x_s_train/255
x_s_test = x_s_test/255
x_t_train = x_t_train/255
x_t_test = x_t_test/255
...
opt = Adam(lr=0.00001)
stae.ae_source_target.compile(loss = losses, optimizer=opt, experimental_run_tf_function = False)
...
recons = stae.ae_source_target.predict([x_s_test, x_t_test])[1]
